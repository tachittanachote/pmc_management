                ...
                <div class="card-body">
                    ...
                    <div>
                        ...
                        <div id="employee-selection">
                            <div class="form-row">
                                    <label for="employee">เลือกช่าง</label>
                                    <select class="form-control mb-2" id="employee">
                                        <option value="" disabled selected hidden>เลือกช่าง</option>
                                        @foreach(\App\User::where('role', '!=', 'admin')->get() as $employee)
                                            <option value="{{$employee->id}}">{{$employee->name}}</option>
                                        @endforeach
                                    </select>
                                    <div id="employeeFeedback" class="invalid-feedback">
                                        โปรดเลือกช่าง
                                    </div>
                                </div>
                        </div>
...
<script>
        ...
        <script type="text/javascript" src="{{ mix('/js/workadmin.js') }}"></script>
@endsection
